...
PM_START_TEXT = """
Heyo Myself Megumi Fushigura, I am Groups Management Bot !! I can Help You Manage Your Group for you!!, send /help for command list...[.](https://telegra.ph/file/a66ae9f11045a17efd8c3.jpg)
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ sᴜᴍᴍᴏɴ ➕️", url="t.me/megumiProbot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="Nobara_"),
        InlineKeyboardButton(
            text="ɢʀᴏᴜᴘ", url=f"https://t.me/AnimeChatAura"),
        InlineKeyboardButton(text="⛩Megumi Support⛩ ", url=f"https://t.me/Megumisupport"


                             ),
    ],
    [
        InlineKeyboardButton(text="ꜱᴛᴀʀᴛ ᴜsɪɴɢ ʙᴏᴛ",
...
HELP_STRINGS = """
Myself Megumi From Tokyo Jujutsu High[.](https://telegra.ph/file/b3efe476b188202e0b81e.jpg) 
"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            "I am Practicing My Jujustsu Skills!\n<b>Haven't slept since:</b> <code>{}</code>".format(
                uptime
            ),
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                     InlineKeyboardButton(
                         text="Kembali", callback_data="yone_back"),
                     InlineKeyboardButton(
                         text="Group", url="https://t.me/The_Phantom_Troupe"
                     )
                 ]
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(
                f"@{SUPPORT_CHAT}", "[I am now online!](https://telegra.ph/file/3e875f26214ad9a8c4fad.jpg)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
    ...
    about_callback_handler = CallbackQueryHandler(
        yone_about_callback, pattern=r"yone_")
