...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text(
        "<code>Wait Appraising Results User-Kun......</code>", parse_mode=ParseMode.HTML)
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThis user is member of 'Throne Holder'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/Echidna_updates/2">?</a>]'.format(
            bot.username)
