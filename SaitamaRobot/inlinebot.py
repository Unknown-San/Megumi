...
from AkazaRobot.utils.inlinehelper import *
from AkazaRobot.utils.pluginhelpers import fetch, json_prettify
from AkazaRobot import pgram as app, OPENWEATHERMAP_ID, TIME_API_KEY
